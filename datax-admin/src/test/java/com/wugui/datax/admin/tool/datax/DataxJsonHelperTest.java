...
public class DataxJsonHelperTest {
    ...
    private JobDatasource getReaderDatasource() {
        ...
        readerDatasource.setJdbcUrl("jdbc:mysql://localhost:3306/datax?serverTimezone=Asia/Shanghai&useLegacyDatetimeCode=false&useSSL=false&nullNamePatternMatchesAll=true&useUnicode=true&characterEncoding=UTF-8");
    ...
    private JobDatasource getWriterDatasource() {
        ...
        writerDatasource.setJdbcUrl("jdbc:mysql://localhost:3306/datax_demo?serverTimezone=Asia/Shanghai&useLegacyDatetimeCode=false&useSSL=false&nullNamePatternMatchesAll=true&useUnicode=true&characterEncoding=UTF-8");
