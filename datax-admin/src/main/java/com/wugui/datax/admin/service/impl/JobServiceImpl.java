...
import com.wugui.datax.admin.dto.TxtfileReaderDto;
...
//        List<Object> rColumns;
        ...
        for (int i = 0; i < rdTables.size(); i++) {
            ...
            if (!dto.getReaderColumnsList().isEmpty()){
                List<String> rColumns;
                rColumns=dto.getReaderColumnsList().get(i);
            ...
            //对rColumns进行区分，判断dto.getTxtfileReaderDto.readerPaths是否为空数组
            ...
            //dto.getTxtfileReaderDto().setReaderPath(rdTables.get(i));

            TxtfileReaderDto txtfileReaderDto=dto.getTxtfileReader();

            txtfileReaderDto.setReaderPath(rdTables.get(i));

            jsonBuild.setTxtfileReader(txtfileReaderDto);
            ...
            if (dto.getReaderColumnsList().isEmpty()) {
                ...
                jsonBuild.setReaderTables(null);
            }
